...
namespace nodejs
{
  ...
  EnPhoneticDistance::Init(v8::Local<v8::Object> exports)
  {
    ...
    tpl->SetClassName(v8::String::NewFromUtf8(isolate, "EnPhoneticDistance", v8::NewStringType::kNormal).ToLocalChecked());
    ...
    exports->Set(context, v8::String::NewFromUtf8(isolate, "EnPhoneticDistance", v8::NewStringType::kNormal).ToLocalChecked(), tpl->GetFunction(context).ToLocalChecked());
  }
  ...
  EnPhoneticDistance::New(const v8::FunctionCallbackInfo<v8::Value>& args)
  {
    ...
    if (args.IsConstructCall()) {
      ...
      isolate->ThrowException(v8::Exception::SyntaxError(
        v8::String::NewFromUtf8(isolate, "Not invoked as constructor, change to: `new EnPhoneticDistance()`", v8::NewStringType::kNormal).ToLocalChecked()));
      return;
    }
  }
  ...
  EnPhoneticDistance::Distance(const v8::FunctionCallbackInfo<v8::Value>& args)
  {
    ...
    if (!enPronunciationType->HasInstance(args[0]) || !enPronunciationType->HasInstance(args[1])) {
      isolate->ThrowException(v8::Exception::TypeError(
          v8::String::NewFromUtf8(isolate, "Expected arguments to be EnPronunciation.", v8::NewStringType::kNormal).ToLocalChecked()));
      return;
    }
